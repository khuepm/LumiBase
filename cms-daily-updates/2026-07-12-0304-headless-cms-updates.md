...
**Date:** 2026-07-12 · **Run:** automated (scheduled task, 03:04 +07) · **Coverage:** 10 headless CMS projects
**Previous run:** 2026-07-12 02:04 (+07)
...
## TL;DR — Changes since previous run (2026-07-12 02:04)

**GitHub issues: no change.** All 10 trackers returned the identical newest open issue (same ID, title, open date) and identical open-issue counts as the 02:04 run. Verified live this run. The last new issue observed across all trackers remains **TinaCMS #7169** (Jul 7).
...
## Strapi
**Open issues:** 396 (verified). Stars ~72.3k. · Issues: https://github.com/strapi/strapi/issues · Blog: https://strapi.io/blog
...
## Directus
**Open issues:** 326 (verified). Stars ~34.8k. · Issues: https://github.com/directus/directus/issues · Blog: https://directus.io/blog
...
## Payload CMS
**Open issues:** 288 (verified). Stars ~41.8k. · Issues: https://github.com/payloadcms/payload/issues · Blog: https://payloadcms.com/blog
...
## Sanity
**Open issues:** 75 (verified). Stars ~6.1k. · Issues: https://github.com/sanity-io/sanity/issues · Blog: https://www.sanity.io/blog
...
## Ghost
**Open issues:** 63 (verified). Stars ~52.8k. · Issues: https://github.com/TryGhost/Ghost/issues · Resources: https://ghost.org/resources/
...
## KeystoneJS
**Open issues:** 100 (verified). Stars ~9.9k. · Issues: https://github.com/keystonejs/keystone/issues · Blog: https://keystonejs.com/blog
...
**Note:** activity remains slow (newest open issue is Apr 3); pinned issue "Node 20 (LTS) support" (#8987) still open. Blog carried forward is stale ("A year of releases in review" — Aug 2024).

---

## TinaCMS
**Open issues:** 378 (verified). Stars ~13.6k. · Issues: https://github.com/tinacms/tinacms/issues · Blog: https://tina.io/blog
...
## Decap CMS
**Open issues:** 559 (verified). Stars ~19.2k. · Issues: https://github.com/decaporg/decap-cms/issues · Blog: https://decapcms.org/blog/
...
## Builder.io
**Open issues:** 62 (verified). Stars ~8.8k. · Issues: https://github.com/BuilderIO/builder/issues · Blog: https://www.builder.io/blog
...
## Medusa
**Open issues:** 111 (verified). Stars ~33k. · Issues: https://github.com/medusajs/medusa/issues · Blog: https://medusajs.com/blog
