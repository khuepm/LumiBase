...
| 4 | content-os | v0.5.0 | (Tùy chọn) bước wizard tạo default constitution draft | pending | tasks.md G.4 | `apps/cms/src/services/constitution-service.ts:312` — không có constitution active thì publish gate cho qua hết (graceful by design); cần quyết định template trước khi implement |
