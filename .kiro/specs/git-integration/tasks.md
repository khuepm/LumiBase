...
- [x] 1. Schema + migration
  ...
  - [x] 1.2 Sinh migration Drizzle (viết tay `0009_git_integration.sql`, bảng `lumibase_git_*`, idempotent `CREATE TABLE IF NOT EXISTS`) (Req 14.3; design §3)
