...
- `0034_auth_external_issuers` — adds the per-site trusted-issuer table (public
...
- See [docs/en/security/external-jwt-auth.md](docs/en/security/external-jwt-auth.md)
