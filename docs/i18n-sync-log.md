...
## 2026-07-12T05:50:14.462Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 136

Summary — up-to-date: 47, translated: 0, preserved: 1, conflicts: 1, planned: 88

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-12T05-50-14-599Z.bak.md` |
| `roadmap/git-integration.md` | vi | — | preserve-and-translate | en-file-is-vietnamese; no vi counterpart |
...
| `roadmap/git-integration.md` | vi → en | en-file-is-vietnamese; no vi counterpart |
...
## 2026-07-12T05:10:25.016Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-12T05-10-25-159Z.bak.md` |
...
## 2026-07-12T02:39:08.511Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-12T02-39-08-642Z.bak.md` |
...
## 2026-07-12T01:53:52.406Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-12T01-53-52-545Z.bak.md` |
