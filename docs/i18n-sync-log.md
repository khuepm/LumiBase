...
## 2026-09-26T04:15:46.761Z — mode `preserve-only` (effective `preserve-only`)
...
## 2026-09-26T04:02:42.702Z — mode `preserve-only` (effective `preserve-only`)
...
## 2026-09-26T03:18:22.979Z — mode `preserve-only` (effective `preserve-only`)
...
## 2026-09-23T15:04:31.519Z — mode `preserve-only` (effective `preserve-only`)
...
## 2026-09-15T15:09:56.541Z — mode `preserve-only` (effective `preserve-only`)
...
## 2026-09-15T04:09:55.466Z — mode `plan` (effective `plan`)
...
## 2026-09-15T03:56:07.855Z — mode `plan` (effective `plan`)
...
## 2026-09-14T21:34:04.814Z — mode `plan` (effective `plan`)
...
## 2026-09-14T21:26:17.056Z — mode `plan` (effective `plan`)
...
## 2026-09-14T20:01:42.793Z — mode `preserve-only` (effective `preserve-only`)
...
## 2026-09-13T14:54:55.923Z — mode `preserve-only` (effective `preserve-only`)
...
## 2026-09-10T20:56:09.026Z — mode `preserve-only` (effective `preserve-only`)
...
## 2026-09-10T19:40:51.390Z — mode `preserve-only` (effective `preserve-only`)
...
## 2026-09-10T03:03:42.885Z — mode `preserve-only` (effective `preserve-only`)
...
## 2026-09-06T18:55:52.657Z — mode `preserve-only` (effective `preserve-only`)
...
## 2026-09-06T18:41:32.498Z — mode `plan` (effective `plan`)
...
## 2026-09-03T04:32:28.583Z — mode `preserve-only` (effective `preserve-only`)
...
## 2026-09-01T19:39:36.305Z — mode `preserve-only` (effective `preserve-only`)
...
Summary — up-to-date: 90, translated: 0, preserved: 0, conflicts: 0, planned: 53
...
## 2026-07-31T20:44:54.351Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 142

Summary — up-to-date: 91, translated: 0, preserved: 0, conflicts: 0, planned: 51
...
## 2026-07-31T20:33:13.379Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 142

Summary — up-to-date: 93, translated: 0, preserved: 0, conflicts: 0, planned: 49
...
## 2026-07-31T19:11:06.635Z — mode `apply` (effective `preserve-only`)
...
| `architecture/decisions/index.md` | en → vi | source changed since last sync |
| `architecture/page-hydration.md` | en → vi | source changed since last sync |
| `cdc/deployment-cloudflare-workers.md` | en → vi | source changed since last sync |
| `compliance/README.md` | en → vi | source changed since last sync |
| `compliance/data-map.md` | en → vi | source changed since last sync |
| `compliance/data-residency.md` | en → vi | source changed since last sync |
| `compliance/dpa-template.md` | en → vi | source changed since last sync |
...
| `compliance/provider-google-apple.md` | en → vi | source changed since last sync |
| `compliance/user-rights-catalog.md` | en → vi | source changed since last sync |
| `contributing/index.md` | en → vi | source changed since last sync |
| `deployment/cloudflare.md` | en → vi | source changed since last sync |
| `deployment/docker.md` | en → vi | source changed since last sync |
| `deployment/google-cloud-vm.md` | en → vi | source changed since last sync |
| `deployment/local-development.md` | en → vi | source changed since last sync |
...
## 2026-07-29T05:36:03.772Z — mode `apply` (effective `preserve-only`)
...
## 2026-07-29T00:47:36.755Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 142

Summary — up-to-date: 92, translated: 0, preserved: 0, conflicts: 0, planned: 50
...
## 2026-07-27T05:22:25.072Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 142

Summary — up-to-date: 40, translated: 0, preserved: 0, conflicts: 3, planned: 99

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-27T05-22-25-242Z.bak.md` |
| `mcp/index.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/index.md.2026-07-27T05-22-25-242Z.bak.md` |
| `mcp/mcp-application-analysis.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/mcp-application-analysis.md.2026-07-27T05-22-25-243Z.bak.md` |
...
| `security/dependency-overrides.md` | en → vi | source changed since last sync |
| `security/idor-testing.md` | en → vi | source changed since last sync |
| `security/owasp-api-top-10-audit.md` | en → vi | missing vi translation |
| `security/route-guards.md` | en → vi | source changed since last sync |
| `security/runtime-security-guards-plan.md` | en → vi | source changed since last sync |
| `tutorials/index.md` | en → vi | source changed since last sync |
| `tutorials/nextjs-quickstart.md` | en → vi | source changed since last sync |
...
## 2026-07-27T04:16:24.861Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-27T04-16-25-002Z.bak.md` |
| `mcp/index.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/index.md.2026-07-27T04-16-25-002Z.bak.md` |
| `mcp/mcp-application-analysis.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/mcp-application-analysis.md.2026-07-27T04-16-25-002Z.bak.md` |
...
## 2026-07-25T23:32:57.559Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-25T23-32-57-707Z.bak.md` |
| `mcp/index.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/index.md.2026-07-25T23-32-57-707Z.bak.md` |
| `mcp/mcp-application-analysis.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/mcp-application-analysis.md.2026-07-25T23-32-57-707Z.bak.md` |
...
## 2026-07-25T12:57:10.096Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 141

Summary — up-to-date: 40, translated: 0, preserved: 0, conflicts: 3, planned: 98

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-25T12-57-10-246Z.bak.md` |
| `mcp/index.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/index.md.2026-07-25T12-57-10-247Z.bak.md` |
| `mcp/mcp-application-analysis.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/mcp-application-analysis.md.2026-07-25T12-57-10-247Z.bak.md` |
...
## 2026-07-25T08:41:43.869Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 141

Summary — up-to-date: 41, translated: 0, preserved: 0, conflicts: 3, planned: 97

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-25T08-41-43-983Z.bak.md` |
| `mcp/index.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/index.md.2026-07-25T08-41-43-983Z.bak.md` |
| `mcp/mcp-application-analysis.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/mcp-application-analysis.md.2026-07-25T08-41-43-983Z.bak.md` |
...
## 2026-07-25T08:30:55.720Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 141

Summary — up-to-date: 45, translated: 0, preserved: 0, conflicts: 3, planned: 93

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-25T08-30-55-872Z.bak.md` |
| `mcp/index.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/index.md.2026-07-25T08-30-55-872Z.bak.md` |
| `mcp/mcp-application-analysis.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/mcp-application-analysis.md.2026-07-25T08-30-55-872Z.bak.md` |
...
## 2026-07-24T04:02:55.999Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-24T04-02-56-158Z.bak.md` |
| `mcp/index.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/index.md.2026-07-24T04-02-56-158Z.bak.md` |
| `mcp/mcp-application-analysis.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/mcp-application-analysis.md.2026-07-24T04-02-56-158Z.bak.md` |
...
Summary — up-to-date: 45, translated: 0, preserved: 0, conflicts: 0, planned: 95
...
| `mcp/index.md` | vi | vi | conflict | en file holds Vietnamese that differs from existing docs/vi |
| `mcp/mcp-application-analysis.md` | vi | vi | conflict | en file holds Vietnamese that differs from existing docs/vi |
...
## 2026-07-18T21:51:12.118Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 139

Summary — up-to-date: 44, translated: 0, preserved: 0, conflicts: 3, planned: 92

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-18T21-51-12-230Z.bak.md` |
| `mcp/index.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/index.md.2026-07-18T21-51-12-231Z.bak.md` |
| `mcp/mcp-application-analysis.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/mcp-application-analysis.md.2026-07-18T21-51-12-231Z.bak.md` |
...
## 2026-07-18T21:02:33.215Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-18T21-02-33-367Z.bak.md` |
| `mcp/index.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/index.md.2026-07-18T21-02-33-367Z.bak.md` |
| `mcp/mcp-application-analysis.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/mcp-application-analysis.md.2026-07-18T21-02-33-368Z.bak.md` |
...
## 2026-07-18T20:57:57.849Z — mode `plan` (effective `plan`)

Engine: `claude` · API key: absent · files scanned: 139

Summary — up-to-date: 44, translated: 0, preserved: 0, conflicts: 0, planned: 95
...
## 2026-07-18T20:49:59.872Z — mode `plan` (effective `plan`)
...
## 2026-07-16T05:11:56.086Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-16T05-11-56-235Z.bak.md` |
| `mcp/index.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/index.md.2026-07-16T05-11-56-235Z.bak.md` |
| `mcp/mcp-application-analysis.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/mcp-application-analysis.md.2026-07-16T05-11-56-235Z.bak.md` |
...
## 2026-07-16T04:41:56.664Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 139

Summary — up-to-date: 44, translated: 0, preserved: 0, conflicts: 1, planned: 94

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-16T04-41-56-811Z.bak.md` |
...
## 2026-07-14T12:54:09.830Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-14T12-54-09-976Z.bak.md` |
...
## 2026-07-12T06:35:19.140Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-12T06-35-19-280Z.bak.md` |
...
## 2026-07-12T05:55:02.484Z — mode `plan` (effective `plan`)

Engine: `claude` · API key: absent · files scanned: 137

Summary — up-to-date: 44, translated: 0, preserved: 0, conflicts: 0, planned: 93
...
## 2026-07-12T05:15:04.599Z — mode `plan` (effective `plan`)

Engine: `claude` · API key: absent · files scanned: 135

Summary — up-to-date: 44, translated: 0, preserved: 0, conflicts: 0, planned: 91
...
## 2026-07-12T03:28:55.237Z — mode `plan` (effective `plan`)
...
## 2026-07-12T03:12:27.715Z — mode `plan` (effective `plan`)
...
## 2026-07-11T23:53:39.960Z — mode `plan` (effective `plan`)
...
## 2026-07-11T16:54:43.419Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 134

Summary — up-to-date: 47, translated: 0, preserved: 0, conflicts: 1, planned: 86

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-11T16-54-43-550Z.bak.md` |
...
## 2026-07-11T06:26:11.804Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 133

Summary — up-to-date: 47, translated: 0, preserved: 0, conflicts: 1, planned: 85

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-11T06-26-11-938Z.bak.md` |
...
## 2026-07-11T03:49:19.531Z — mode `plan` (effective `plan`)

Engine: `claude` · API key: absent · files scanned: 133

Summary — up-to-date: 47, translated: 0, preserved: 0, conflicts: 0, planned: 86
...
## 2026-07-11T03:48:43.655Z — mode `plan` (effective `plan`)

Engine: `claude` · API key: absent · files scanned: 133

Summary — up-to-date: 46, translated: 0, preserved: 0, conflicts: 0, planned: 87
...
## 2026-07-11T03:48:38.601Z — mode `plan` (effective `plan`)
...
## 2026-07-10T09:36:33.098Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 133

Summary — up-to-date: 46, translated: 0, preserved: 0, conflicts: 1, planned: 86

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-10T09-36-33-237Z.bak.md` |
...
## 2026-07-09T06:04:41.711Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-09T06-04-41-850Z.bak.md` |
...
## 2026-07-08T20:20:30.383Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 132

Summary — up-to-date: 29, translated: 0, preserved: 0, conflicts: 1, planned: 102

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-08T20-20-30-517Z.bak.md` |
...
| `api/hono-api-spec.md` | en → vi | source changed since last sync |
| `architecture/decisions/adr-011-user-management-realms.md` | en → vi | missing vi translation |
| `architecture/decisions/index.md` | en → vi | source changed since last sync |
| `architecture/page-hydration.md` | en → vi | source changed since last sync |
| `architecture/physical-collections.md` | en → vi | missing vi translation |
| `architecture/realtime-websocket-implementation.md` | en → vi | source changed since last sync |
...
| `compliance/provider-google-apple.md` | en → vi | source changed since last sync |
| `compliance/user-rights-catalog.md` | en → vi | source changed since last sync |
| `contributing/code-first-config.md` | en → vi | missing vi translation |
...
| `security/route-guards.md` | en → vi | source changed since last sync |
| `security/runtime-security-guards-plan.md` | en → vi | source changed since last sync |
| `security/user-management.md` | en → vi | missing vi translation |
| `tutorials/index.md` | en → vi | source changed since last sync |
| `tutorials/nextjs-quickstart.md` | en → vi | source changed since last sync |
| `ui/studio-ui-spec.md` | vi → en | en duplicates vi content; replace en with English translation |
...
## 2026-07-08T05:54:07.183Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 132

Summary — up-to-date: 30, translated: 0, preserved: 0, conflicts: 1, planned: 101

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-08T05-54-07-315Z.bak.md` |
...
## 2026-07-07T18:34:05.557Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 130

Summary — up-to-date: 32, translated: 0, preserved: 0, conflicts: 1, planned: 97

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-07T18-34-05-686Z.bak.md` |
...
## 2026-07-07T18:30:13.037Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-07T18-30-13-136Z.bak.md` |
...
## 2026-07-07T12:01:03.930Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 130

Summary — up-to-date: 32, translated: 0, preserved: 1, conflicts: 1, planned: 97

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/collection-preview.md` | vi | — | preserve-and-translate | en-file-is-vietnamese; no vi counterpart |
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-07T12-01-04-064Z.bak.md` |
...
| `features/bookmarks-presets.md` | vi → en | en duplicates vi content; replace en with English translation |
| `features/cloudflare-auth.md` | vi → en | en duplicates vi content; replace en with English translation |
| `features/collection-preview.md` | vi → en | en-file-is-vietnamese; no vi counterpart |
| `features/collections-builder.md` | en → vi | source changed since last sync |
| `features/deployment-integrations.md` | en → vi | missing vi translation |
| `features/directus-data-model-parity-tasks.md` | en → vi | missing vi translation |
| `features/display-templates.md` | vi → en | en duplicates vi content; replace en with English translation |
...
## 2026-07-07T08:18:48.926Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 129

Summary — up-to-date: 32, translated: 0, preserved: 0, conflicts: 1, planned: 96

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-07T08-18-49-061Z.bak.md` |
...
## 2026-07-07T07:47:58.471Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 128

Summary — up-to-date: 32, translated: 0, preserved: 0, conflicts: 1, planned: 95

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-07T07-47-58-594Z.bak.md` |
...
## 2026-07-06T23:26:57.132Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 127

Summary — up-to-date: 32, translated: 0, preserved: 0, conflicts: 1, planned: 94

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-06T23-26-57-251Z.bak.md` |
...
## 2026-07-06T12:06:27.543Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-06T12-06-27-664Z.bak.md` |
...
## 2026-07-06T10:30:26.513Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-06T10-30-26-632Z.bak.md` |
...
## 2026-07-06T04:41:04.950Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 126

Summary — up-to-date: 31, translated: 0, preserved: 0, conflicts: 1, planned: 94

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-06T04-41-05-071Z.bak.md` |
...
## 2026-07-05T05:32:27.341Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 126

Summary — up-to-date: 14, translated: 0, preserved: 0, conflicts: 1, planned: 111

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-05T05-32-27-458Z.bak.md` |
...
| `architecture/decisions/adr-010-lumibase-table-prefix.md` | en → vi | missing vi translation |
...
| `features/cloudflare-auth.md` | vi → en | en duplicates vi content; replace en with English translation |
| `features/collections-builder.md` | en → vi | source changed since last sync |
| `features/content-releases.md` | en → vi | missing vi translation |
| `features/deployment-integrations.md` | en → vi | missing vi translation |
| `features/directus-data-model-parity-tasks.md` | en → vi | missing vi translation |
| `features/display-templates.md` | vi → en | en duplicates vi content; replace en with English translation |
| `features/field-types-and-config.md` | en → vi | source changed since last sync |
...
| `sdk/typegen.md` | en → vi | missing vi translation |
| `security/dependency-overrides.md` | en → vi | source changed since last sync |
| `security/external-jwt-auth.md` | en → vi | missing vi translation |
| `security/idor-testing.md` | en → vi | source changed since last sync |
| `security/route-guards.md` | en → vi | missing vi translation |
| `security/runtime-security-guards-plan.md` | en → vi | source changed since last sync |
| `tutorials/index.md` | en → vi | source changed since last sync |
| `tutorials/nextjs-quickstart.md` | en → vi | source changed since last sync |
| `ui/studio-ui-spec.md` | vi → en | en duplicates vi content; replace en with English translation |
...
## 2026-07-04T07:01:20.001Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-04T07-01-20-110Z.bak.md` |
...
## 2026-07-03T18:40:47.776Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 125

Summary — up-to-date: 15, translated: 0, preserved: 1, conflicts: 1, planned: 109

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-03T18-40-47-895Z.bak.md` |
| `roadmap/collection-create-modes.md` | vi | — | preserve-and-translate | en-file-is-vietnamese; no vi counterpart |
...
| `release/npm-publishing.md` | vi → en | missing en translation |
| `roadmap/agent-harness-implementation.md` | vi → en | missing en translation |
| `roadmap/collection-create-modes.md` | vi → en | en-file-is-vietnamese; no vi counterpart |
| `roadmap/phase-d1-users.md` | en → vi | source changed since last sync |
| `roadmap/post-ga-walkthrough.md` | vi → en | en duplicates vi content; replace en with English translation |
| `roadmap/studio-content-slices.md` | vi → en | en duplicates vi content; replace en with English translation |
| `sdk/index.md` | en → vi | missing vi translation |
...
## 2026-07-03T18:22:07.082Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 124

Summary — up-to-date: 15, translated: 0, preserved: 0, conflicts: 1, planned: 108

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-03T18-22-07-192Z.bak.md` |
...
## 2026-07-03T18:11:47.757Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-03T18-11-47-870Z.bak.md` |
...
## 2026-07-03T18:06:48.573Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-03T18-06-48-678Z.bak.md` |
...
## 2026-07-03T17:56:02.462Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 123

Summary — up-to-date: 15, translated: 0, preserved: 0, conflicts: 1, planned: 107

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-03T17-56-02-579Z.bak.md` |
...
## 2026-07-03T17:36:16.217Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-03T17-36-16-328Z.bak.md` |
...
## 2026-07-03T13:21:11.139Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 122

Summary — up-to-date: 15, translated: 0, preserved: 0, conflicts: 1, planned: 106

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-03T13-21-11-250Z.bak.md` |
...
## 2026-07-03T13:20:53.936Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-03T13-20-54-051Z.bak.md` |
...
## 2026-07-03T12:32:35.673Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 121

Summary — up-to-date: 15, translated: 0, preserved: 0, conflicts: 1, planned: 105

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-03T12-32-35-782Z.bak.md` |
...
## 2026-07-03T04:50:43.267Z — mode `apply` (effective `preserve-only`)

Engine: `claude` · API key: absent · files scanned: 120

Summary — up-to-date: 15, translated: 0, preserved: 0, conflicts: 1, planned: 104

### Language mismatches / preservation

| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-03T04-50-43-372Z.bak.md` |
...
## 2026-07-02T13:59:16.434Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-02T13-59-16-540Z.bak.md` |
...
## 2026-07-02T13:42:51.696Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-02T13-42-51-802Z.bak.md` |
...
## 2026-07-02T11:45:00.471Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-02T11-45-00-578Z.bak.md` |
...
## 2026-07-02T10:37:18.876Z — mode `apply` (effective `preserve-only`)
...
| File | en lang | vi lang | Action | Note |
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-02T10-37-18-979Z.bak.md` |
