...
## 2026-07-17T03:45:50.327Z — mode `apply` (effective `preserve-only`)
...
|------|---------|---------|--------|------|
| `features/user-management.md` | vi | vi | conflict | preserved → `.i18n/preserved/features/user-management.md.2026-07-17T03-45-50-430Z.bak.md` |
| `mcp/index.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/index.md.2026-07-17T03-45-50-430Z.bak.md` |
| `mcp/mcp-application-analysis.md` | vi | vi | conflict | preserved → `.i18n/preserved/mcp/mcp-application-analysis.md.2026-07-17T03-45-50-430Z.bak.md` |
